...
define(BG_SSO_URL, 'http://sso.webaapp.com/api/api.php'); //SSO 地址
define(BG_SSO_APPID, 4); //APP ID
define(BG_SSO_APPKEY, 'ebc2de1c4f08ba893a6613cd7757ceb5'); //APP KEY
define(BG_SSO_APPSECRET, 'wwcCMK5e3aBSKgA1'); //APP KEY
...
$arr_userSso = $obj_sso->sso_user_login($str_userName, $str_userPass); //调用登录方法
