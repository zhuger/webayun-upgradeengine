<?php
if(!defined('BG_SSO_URL')) {
	exit('Access denied');
}
define('SSO_ROOT', substr(__FILE__, 0, -14));

require(SSO_ROOT . './lib/session.class.php');
require(SSO_ROOT . './lib/notify.class.php');
require(SSO_ROOT . './lib/sso.class.php');
require(SSO_ROOT . './lib/file.class.php');
require(SSO_ROOT . './lib/sync.class.php');
require(SSO_ROOT . './lib/crypt.class.php');
require(SSO_ROOT . './lib/sign.class.php');
 ...
 * @return void
 */
function fn_eachArray($arr, $method = 'encode',$test=false) {
